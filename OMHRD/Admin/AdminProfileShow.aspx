<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdminProfileShow.aspx.cs" Inherits="OMHRD.Admin.AdminProfileShow" EnableEventValidation="false" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <h2 style="font-size: 14px;">Update your information below, then click the Submit Changes button.</h2>
                <br />
                <h2 style="font-size: 14px;">You can change the information as often as you like. </h2>
                <h2 style="font-size: 14px;">The changes made here will be active immediately.  </h2>
                <br />
                <h2 style="font-size: 14px;">We recommend that you change your password often. </h2>
                <br />
            </div>
            <div class="col-md-6">
                <p>&nbsp;</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <%-- <div class="panel-heading" style="padding-right: 7px;">
                            <h2><strong>PASSWORD</strong> <a href="Default.aspx"><span class="glyphicon glyphicon-refresh"></span></a></h2>
                        </div>
                        <div class="table-responsive allowTextWrap">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>Old Password :</td>
                                        <td>
                                            <asp:TextBox ID="txtoldpass" TextMode="Password" runat="server" CssClass="form-control"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>New Password :</td>
                                        <td>
                                            <asp:TextBox ID="txtnewp" TextMode="Password" runat="server" CssClass="form-control"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>Confirm  Password :</td>
                                        <td>
                                            <asp:TextBox ID="txtcurrentpass" TextMode="Password" runat="server" CssClass="form-control"></asp:TextBox></td>
                                    </tr>
                                </tbody>
                            </table>
                            <p>
                                New password must have at least one uppercase letter, one lowercase letter, one number, one special character, and be between 8 and 16 characters.
                            </p>
                        </div>--%>
