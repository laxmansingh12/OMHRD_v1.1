        ...
        <div class="panel panel-primary">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <br />
                        <asp:GridView ID="gdvNotice" runat="server" AllowPaging="True" AutoGenerateColumns="False" Width="100%" OnPageIndexChanging="gdvNotice_PageIndexChanging" CellPadding="4" ForeColor="#333333" GridLines="None">
